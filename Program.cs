...
string[] names2 = new[] { "Christine", "James", "Rehanna", "Tommy" };
...
grid2[0, 0] = "First"; // assign string values
// and so on
grid2[2, 3] = "Dog";
